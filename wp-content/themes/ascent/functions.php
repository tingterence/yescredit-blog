 ...
 /* Add Menu Support */
    ...
    register_nav_menus(
        array(
            ...
            'footer-links' => __('Footer Links', 'ascent')
        )
    );
    ...
    add_image_size('social_thumb', 560, 292, true);
...
add_action('init', 'skyrocket_pagination'); // Add our HTML5 Pagination
...
function ascent_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Description', 'ascent' ),
        'id'            => 'footer-description',
        'before_widget' => '<aside id="%1$s" class="%2$s col-3">',
        'after_widget'  => '</aside>',
    ...
    register_sidebar( array(
        'name'          => __( 'Need Help', 'ascent' ),
        'id'            => 'need-help',
        'before_widget' => '<aside id="%1$s" class="need %2$s col-3">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h4 class="text-uppercase">',
        'after_title'   => '</h4>',
    ) );
